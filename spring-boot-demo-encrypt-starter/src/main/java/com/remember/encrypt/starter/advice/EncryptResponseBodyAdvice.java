...
import com.remember.encrypt.starter.annotation.encrypt.*;
import com.remember.encrypt.starter.bean.EncryptAnnotationInfoBean;
...
import com.remember.encrypt.starter.exception.EncryptBodyFailException;
import com.remember.encrypt.starter.exception.EncryptMethodNotFoundException;
...
public class EncryptResponseBodyAdvice implements ResponseBodyAdvice {
    ...
    private String switchEncrypt(String formatStringBody, EncryptAnnotationInfoBean infoBean) {
        ...
        if (method == EncryptBodyMethod.RSA) {
            ...
            byte[] encodedData = RSAUtil.encrypt(bytes, config.getRsaConfig().getPublicKey(), config.getRsaConfig().getMaxEncryptBlock());
