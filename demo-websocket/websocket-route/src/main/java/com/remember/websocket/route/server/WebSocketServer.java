package com.remember.websocket.route.server;


import com.remember.websocket.route.entity.Demo02Message;
import com.remember.websocket.route.entity.RouteInfo;
import com.remember.websocket.route.utils.RedisUtils;
...
import static com.remember.websocket.route.constant.WebSocketConstant.USER_ROUTES;
...
public class WebSocketServer {
    ...
    public void onOpen(Session session, @PathParam("name") String name) throws IOException {
        ...
        routeInfo.setServerId(Demo02Message.ROUTING_KEY);
        routeInfo.setRoutingKey(Demo02Message.ROUTING_KEY);
        redisUtils.set(USER_ROUTES + name, routeInfo);
    ...
    public void onClose(Session session) {
        ...
        // 用户下线
//        redisUtils.del(USER_ROUTES + name);
        // 在线人数减一
        reduceOnlineCount();
    }
